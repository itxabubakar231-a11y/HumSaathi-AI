...
const ADULT_QUESTIONS = {
  ...
  ur: [
    ...
    { id: 'a4', area: 'vocabulary', skill: 'vocabulary', prompt: '"Receipt" کیا ہے؟', options: ['ادائیگی کا ثبوت', 'گreeting card', 'موسم کی رپورٹ'], correctAnswer: 'ادائیگی کا ثبوت' },
...
export function getAssessmentQuestions(persona, language) {
  const lang = language || 'en';
  if (persona === 'child') return CHILD_QUESTIONS[lang] || CHILD_QUESTIONS.en;
  if (persona === 'teen') return TEEN_QUESTIONS[lang] || TEEN_QUESTIONS.en;
  return ADULT_QUESTIONS[lang] || ADULT_QUESTIONS.en;
}
